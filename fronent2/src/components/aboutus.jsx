   ...
   const handleLogout=async(e)=>{
    ...
    <div className="sm:w-1/2 p-5">
        <div className="text">
            ...
            <h2 className="my-4 font-bold text-3xl  sm:text-4xl ">About <span className="text-indigo-600">UIET Community</span>
            </h2>
            <p className="text-gray-700">
            UIET is a flagship institution of CSJM University and is located in the 264-acre sprawling, lush green campus of university. The institute offers
             six B. Tech courses in five branches of engineering – Chemical Engineering, Computer Science and Engineering, Electronics & Communication Engineering, Information technology, and Mechanical Engineering. 
            Apart from B. Tech courses, UIET also offers Bachelors and Masters courses in Computer Application, PG Diploma courses and Vocational courses.
            </p>
        </div>
      </div>
    </div>

        <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r from-green-100 to-green-50 px-6 py-16 text-center m-10">
    <div className="relative m-auto max-w-xl">
        ...
        <a href="#" target="_blank">
            <h2
                ...
                <span className="font-bold underline underline-offset-2">A++</span> NAAC
            </h2>
        </a>
        <p className="mt-4 font-dm-sans text-desktop-paragraph text-slate-body">Got A++ ranting from NAAC team</p>
